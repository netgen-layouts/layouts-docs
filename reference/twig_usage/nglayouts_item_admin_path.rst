...
This function is used to generate an URL to an item from your CMS admin
interface.
...
.. code-block:: twig
    ...
    <a href="{{ nglayouts_item_admin_path(item) }}">{{ item.name }}</a>
...
.. code-block:: twig
    ...
    <a href="{{ nglayouts_item_admin_path([42, 'ibexa_location']) }}">{{ 'My item' }}</a>
...
.. code-block:: twig
    ...
    <a href="{{ nglayouts_item_admin_path('ibexa-location://42') }}">{{ 'My item' }}</a>
